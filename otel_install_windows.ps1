...
$Agentversion = "0.95.0"
$os = "windows"
$TarFile = "otelcol-contrib_'$Agentversion'_'$os'_386.tar.gz"
$OTelURL = "https://github.com/open-telemetry/opentelemetry-collector-releases/releases/download/v$Agentversion/$TarFile"
